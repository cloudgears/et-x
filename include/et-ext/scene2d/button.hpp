...
class Button : public TextElement {
 public:
  ...
  enum Type { Type_PushButton, Type_CheckButton };

  enum ImageLayout { ImageLayout_Left, ImageLayout_Right, ImageLayout_Top, ImageLayout_Bottom };
 ...
 public:
  Button(const std::string& title, const Font::Pointer& font, float, Element2d* parent, const std::string& name = emptyString);
