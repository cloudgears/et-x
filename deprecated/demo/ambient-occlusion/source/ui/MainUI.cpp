...
MainUI::MainUI(RenderContext* rc) {
  ...
  buttonDiffuse->clicked.connect([this](s2d::Button*) { _aoParameters.showDiffuse = !_aoParameters.showDiffuse; });
  ...
  buttonBlur->clicked.connect([this](s2d::Button*) { _aoParameters.performBlur = !_aoParameters.performBlur; });
}
